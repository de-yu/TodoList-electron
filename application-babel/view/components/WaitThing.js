...
var _WaitThing = require("./StyleComponent/WaitThing");
...
function (_React$Component) {
  _inherits(WaitThing, _React$Component);

  function WaitThing(props) {
    var _this;

    _classCallCheck(this, WaitThing);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(WaitThing).call(this));
    _this.state = {
      data: []
    };
    return _this;
  ...
  _createClass(WaitThing, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Main.Main, null, _react.default.createElement(_WaitThing.WaitBoard, null, _react.default.createElement(_FinishThing.BoardHeader, null, _react.default.createElement(_FinishThing.Header, null, "\u672A\u5B8C\u6210\u4E8B\u9805")), _react.default.createElement(_FinishThing.Content, null, element), _react.default.createElement(_FinishThing.Footer, null)));
    }
  }]);
